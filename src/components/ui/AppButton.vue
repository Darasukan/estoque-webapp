...
const variantClasses = computed(() => ({
  primary: 'ds-button-primary bg-primary-500 hover:bg-primary-400 dark:bg-primary-500 dark:hover:bg-primary-400',
...
<template>
  <button
    ...
    class="inline-flex items-center justify-center gap-2 rounded-md font-medium transition-[color,background-color,transform] duration-150 active:scale-[0.97] motion-reduce:active:scale-100 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
